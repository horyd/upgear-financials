...
exports.disposalSchedule = disposalSchedule;
exports.originationSchedule = originationSchedule;
...
function disposalSchedule(fee, term, rate) {
...
function originationSchedule(fee, term, rate) {
  var ratePlusOne = 1 + rate / 12;
