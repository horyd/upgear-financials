...
exports.default = function (rrp, rv, depreciationPower, operatingLife, writeOffMonths) {
  ...
  // n-ic
  var k = depreciationPower * (rrp - rv - depnInWriteOffPeriod * (operatingLife - age)) / Math.pow(operatingLife - age, depreciationPower);
  ...
  var byMonth = Array.from({
    ...
    if (i <= operatingLife - age) {
      ...
      // n-ic
      var y = k / depreciationPower * (Math.pow(operatingLife - age, depreciationPower) - Math.pow(i - (operatingLife - age), depreciationPower)) + depnInWriteOffPeriod * i;
